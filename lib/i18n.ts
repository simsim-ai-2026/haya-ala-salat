...
const EN = {
  ...
  'setup.notificationsTitle': 'Prayer reminders',
  'setup.notificationsSubtitle': 'Allow notifications so the call to prayer reaches you on time.',
  'setup.notificationsBody':
    'A reminder at the start of each prayer time, calculated for the location you picked.',
  'setup.notificationsAllow': 'Allow notifications',
  'setup.notificationsAsking': 'Asking…',
  'setup.notificationsSkip': 'Not now',
  'setup.notificationsGranted': 'Reminders are on.',
  'setup.notificationsDenied':
    'Notifications are off. You can turn them on later in your device settings.',
  'setup.notificationsUnsupported': 'Notifications are not available in this version of the app.',
  'setup.clockTitle': 'Time format',
  'setup.clockSubtitle': 'How prayer times are shown on your schedule.',
...
const AR: Dictionary = {
  ...
  'setup.notificationsTitle': 'تنبيهات الصلاة',
  'setup.notificationsSubtitle': 'اسمح بالإشعارات ليصلك الأذان في وقته.',
  'setup.notificationsBody': 'تنبيه عند دخول وقت كل صلاة، محسوب حسب الموقع الذي اخترته.',
  'setup.notificationsAllow': 'السماح بالإشعارات',
  'setup.notificationsAsking': 'جارٍ الطلب…',
  'setup.notificationsSkip': 'ليس الآن',
  'setup.notificationsGranted': 'تم تفعيل التنبيهات.',
  'setup.notificationsDenied': 'الإشعارات معطّلة. يمكنك تفعيلها لاحقاً من إعدادات جهازك.',
  'setup.notificationsUnsupported': 'الإشعارات غير متاحة في هذه النسخة من التطبيق.',
  'setup.clockTitle': 'صيغة الوقت',
...
const FR: Dictionary = {
  ...
  'setup.notificationsTitle': 'Rappels de prière',
  'setup.notificationsSubtitle': "Autorisez les notifications pour recevoir l'appel à l'heure.",
  'setup.notificationsBody':
    'Un rappel au début de chaque prière, calculé pour le lieu que vous avez choisi.',
  'setup.notificationsAllow': 'Autoriser les notifications',
  'setup.notificationsAsking': 'Demande en cours…',
  'setup.notificationsSkip': 'Plus tard',
  'setup.notificationsGranted': 'Les rappels sont activés.',
  'setup.notificationsDenied':
    'Les notifications sont désactivées. Vous pourrez les activer dans les réglages de votre appareil.',
  'setup.notificationsUnsupported':
    "Les notifications ne sont pas disponibles dans cette version de l'application.",
  'setup.clockTitle': "Format de l'heure",
